...
def main(args):
    ...
    # checkpoint_path = '/opt/data/private/Attack/IRBA/log/modelnet10_pointnet_cls/5.0_5.0_16_0.1/irba-baseline/checkpoints/last_model.pth'
    checkpoint_path = '/opt/data/private/Attack/IRBA/log/modelnet40_pointnet_cls/5.0_5.0_16_0.1/2024-10-12_14-14/checkpoints/last_model.pth'
    ...
    if not os.path.exists(checkpoint_path):
        print("path===>>",os.path.exists(checkpoint_path))
