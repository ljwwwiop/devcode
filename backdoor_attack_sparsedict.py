...
from data_utils.ModelNetDataLoader_sparse import ModelNetDataLoader
from data_utils.ShapeNetDataLoader import ShapeNetDataLoader
from data_utils.ModelNetDataLoader_sparse import BDModelNetDataLoader
...
def main(args):
    ...
    # checkpoint_path = '/opt/data/private/Attack/IRBA/log/modelnet10_pointnet_cls/5.0_5.0_16_0.1/2024-10-10_09-14/checkpoints/last_model.pth'
...
## python backdoor_attack_sparsedict.py --dataset modelnet10 --num_category 10 --model pointnet_cls --poisoned_rate 0.1 --target_label 8 --num_anchor 16 --R_alpha 5 --S_size 5 --process_data --use_uniform_sample --gpu 0
